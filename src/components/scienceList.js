...
import { fetchScience } from '../actions'
...
class ScienceList extends React.Component {
    componentDidMount() {
...
export default connect(mapStateToProps, { fetchScience })(ScienceList);