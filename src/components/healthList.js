...
class HealthList extends React.Component {
    componentDidMount() {
                        ...
                        <div className="col-lg-3" key={value.id = uuidv4()}>
                            <div className="card mb-5 shadow-sm">
                                ...
                                <div className="card-image">
                                    ...
                                    <a className="card-action-health" ><img src="https://cdn-icons-png.flaticon.com/512/2107/2107845.png" height={25} /></a>
                                    ...
                                    <div className="card-text" style={{color : "#df1c1ce1"}}>
                                    ...
                                    <a href={value.url} className="card-button-health"  target="_blank" rel='noreferrer'> Show More</a>
                                </div>
                            </div>
                        </div>
                    ))};
...
export default connect(mapStateToProps, { fetchHealth })(HealthList);